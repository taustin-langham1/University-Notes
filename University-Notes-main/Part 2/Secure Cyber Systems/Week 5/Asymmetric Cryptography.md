...
![[Part 2/Secure Cyber Systems/Week 5/Images/Pasted image 20250212112114.png]]
...
![[Part 2/Secure Cyber Systems/Week 5/Images/Pasted image 20250212112815.png]]
...
- Let `h1` and `h2` be two hash functions and let `r` be randomness generated using a random number generator
	- to encrypt a message `m` using public key `pk = (n,e):`
			![[Part 2/Secure Cyber Systems/Week 5/Images/Pasted image 20250212113350.png]]
	- to decrypt a ciphertext c using secret key `sk = d:`
			![[Part 2/Secure Cyber Systems/Week 5/Images/Pasted image 20250212113423.png]]
...
![[Part 2/Secure Cyber Systems/Week 5/Images/Pasted image 20250212114036.png]]
